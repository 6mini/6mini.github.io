---
title: '[Deep Learning Project] Fashion Style Classification(2) CNN Classification Modeling'
description: '코드스테이츠 Section4(Deep Learning) 딥러닝 프로젝트: CNN을 이용한 패션 스타일 분류 모델링'
categories:
 - Project
