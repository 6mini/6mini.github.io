---
title: "[DE 프로젝트 SIXAT] 3. 스파크(Spark) SQL로 데이터 정제 및 분석"
description: '[아파치 스파크(Apache Spark)를 정복하기 위한 데이터 엔지니어링 프로젝트 머신러닝 모빌리티 예측 서비스] 스파크 SQL을 활용하여 모빌리티 데이터 정제 및 분석, 시각화'
categories:
    - Project
