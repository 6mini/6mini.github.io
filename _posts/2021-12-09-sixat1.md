---
title: '[DE 프로젝트 SIXAT] 1. 개요'
description: '[아파치 스파크(Apache Spark)를 정복하기 위한 데이터 엔지니어링 프로젝트 머신러닝 모빌리티 예측 서비스]의 시작, 데이터 엔지니어링과 그 역사 및 트렌드, ETL과 ELT, 배치 및 스트림 프로세싱, 데이터 플로우 오케스트레이션, 간략한 프로젝트 계획'
categories:
 - Project
