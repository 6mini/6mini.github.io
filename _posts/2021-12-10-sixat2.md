---
title: '[DE 프로젝트 SIXAT] 2. 스파크(Spark) 환경 구축'
description: '[아파치 스파크(Apache Spark)를 정복하기 위한 데이터 엔지니어링 프로젝트 머신러닝 모빌리티 예측 서비스]프로젝트 환경 구축 및 모빌리티 데이터 수집, 간단한 핸들링 및 트러블 슈팅'
categories:
    - Project
